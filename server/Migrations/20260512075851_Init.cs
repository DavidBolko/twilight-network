        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsElderOwl = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "CommunityNightOwls",
                columns: table => new
                {
                    ModeratedCommunitiesId = table.Column<Guid>(type: "uuid", nullable: false),
                    NightOwlsId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommunityNightOwls", x => new { x.ModeratedCommunitiesId, x.NightOwlsId });
                    table.ForeignKey(
                        name: "FK_CommunityNightOwls_AspNetUsers_NightOwlsId",
                        column: x => x.NightOwlsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommunityNightOwls_Communities_ModeratedCommunitiesId",
                        column: x => x.ModeratedCommunitiesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCommunity", x => new { x.CommunitiesId, x.MembersId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserCommunity_Communities_CommunitiesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSavedPosts", x => new { x.SavedById, x.SavedPostsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSavedPosts_Posts_SavedPostsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommunityNightOwls_NightOwlsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCommunity_MembersId",
                table: "UserCommunity",
                column: "MembersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSavedPosts_SavedPostsId",
